...
# taken from: https://github.com/debezium/docker-images/blob/master/connect-base/1.1/docker-maven-download.sh
...
MAVEN_REPO_PACKAGE_CLOUD=${MAVEN_REPO_PACKAGE_CLOUD:-"https://packages.shopify.io/priv/${JARS_PACKAGE_CLOUD_TOKEN}/shopify/jars/maven2"}
