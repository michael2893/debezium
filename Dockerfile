...
ENV CDC_LARGE_RECORD_VERSION=31 \
    CDC_REWRITE_NAMESPACE_VERSION=20

ARG JARS_PACKAGE_CLOUD_TOKEN

RUN /app/script/docker-maven-download.sh cdc-jar com/shopify cdc-large-record "$CDC_LARGE_RECORD_VERSION" c505291314e4395ef45430ac002e5f04 && \
