...
ENV CDC_LARGE_RECORD_VERSION=60 \
    CDC_REWRITE_NAMESPACE_VERSION=20

ARG JARS_PACKAGE_CLOUD_TOKEN

RUN /app/script/docker-maven-download.sh shaded-cdc-jar com/shopify cdc-large-record "$CDC_LARGE_RECORD_VERSION" 6c91e73f6f50ad57dcc1e7d2046cf972 && \
