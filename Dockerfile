...
ENV CDC_LARGE_RECORD_VERSION=55 \
    CDC_REWRITE_NAMESPACE_VERSION=20

ARG JARS_PACKAGE_CLOUD_TOKEN

RUN /app/script/docker-maven-download.sh shaded-cdc-jar com/shopify cdc-large-record "$CDC_LARGE_RECORD_VERSION" ef51834fb7fc821195a09a9d88bd933b && \
