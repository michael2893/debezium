...
ENV CDC_LARGE_RECORD_VERSION=24 \
    CDC_REWRITE_NAMESPACE_VERSION=20

ARG JARS_PACKAGE_CLOUD_TOKEN

RUN /app/script/docker-maven-download.sh cdc-jar com/shopify cdc-large-record "$CDC_LARGE_RECORD_VERSION" 6f7d125ffbe120b089c692069dac9f3e && \
